...
import * as ReportLog from "./utils/ReportLog.js";

import { createClient as CreateRedis } from "redis";
export { ConnectionLog, UserBlockModule, VendorDBMigration, SuspicionLog, ReportLog };
...
function connectPg(noRedis) {
    Pg.connect(async function (err, pgMain) {
        ...
        coupons = new mainAgent.Table("coupons");
        mailbox = new mainAgent.Table("mailbox");
